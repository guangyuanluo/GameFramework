...
* 连招检查器
*/
UCLASS(meta = (DisplayName = "连招触发方式Tag检查", ToolTip = "连招触发方式Tag检查"), Abstract)
class GAMEFRAMEWORK_API UCoreAbilityCondition_ComboTriggerWayTag : public UCoreAbilityCondition {
    GENERATED_BODY()
