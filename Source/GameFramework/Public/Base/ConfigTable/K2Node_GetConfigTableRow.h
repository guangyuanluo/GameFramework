...
#include "K2Node.h"
#include "K2Node_GetConfigTableRow.generated.h"
...
UCLASS()
class GAMEFRAMEWORK_API UK2Node_GetConfigTableRow : public UK2Node
{
...
private:
    ...
    bool DataTableContainsId(const UDataTable* DataTable, int Id) const;
};
