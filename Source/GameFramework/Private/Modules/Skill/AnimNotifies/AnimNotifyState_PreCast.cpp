...
#include "AnimNotifyState_PreCast.h"
#include "AbilitySystemGlobals.h"
#include "AbilitySystemComponent.h"
#include "Modules/Skill/SkillBlueprintLibrary.h"

void UAnimNotifyState_PreCast::NotifyBegin(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, float TotalDuration, const FAnimNotifyEventReference& EventReference) {
...
void UAnimNotifyState_PreCast::NotifyEnd(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference) {
