...
class FSkillGroupIDContainerCustomization : public IPropertyTypeCustomization {
public:
    /**
...
private:
    TSharedPtr<IPropertyHandle> SkillGroupIDPropertyHandle;

    void OnSkillGroupIDChange(int SkillGroupID);
};